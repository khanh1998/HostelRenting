...
public class ListenerConfig {
    ...
    public Map<String, Object> consumerConfigurations() {
        ...
        configurations.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, Constant.Kafka.KAFKA_BROKER);
        configurations.put(ConsumerConfig.GROUP_ID_CONFIG, Constant.Kafka.GROUP_ID);
